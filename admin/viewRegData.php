...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    if ($action === 'Approve') {
        ...
        try {
            ...
            $mail->Body = "Dear {$participant['name']},<br><br>Your registration for the event has been approved.<br>Best Regards,<br>CampusConnect Team<br>admin Approved by: {$adminUsername}";
        ...
        try {
            ...
            $mail->Body = "Dear {$participant['name']},<br><br>Your registration for the event has been rejected for the following reason:<br><br><strong style='color: red;'>{$reason}</strong><br><br>admin Rejected by: {$adminUsername}";
