...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errorMessages)) {
        try {
            ...
            // Update co-organizer collection
            $coOrganizerCollection->updateOne(
                ['username' => $username],
                ['$set' => [
                    'username' => $newUsername,
                    'name' => $newName,
            ...
            // Update co-organizers array in events collection
            $eventsCollection->updateMany(
                ['co-organizers' => $username],
                ['$set' => ['co-organizers.$' => $newUsername]]
            );
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="username" value="<?php echo htmlspecialchars($coOrganizer['username']); ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="name" value="<?php echo htmlspecialchars($coOrganizer['name']); ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="email" name="email" value="<?php echo htmlspecialchars($coOrganizer['email']); ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="number" name="phone" value="<?php echo htmlspecialchars($coOrganizer['phone']); ?>" required>
                                </div>
                            </div>
                        </div>
