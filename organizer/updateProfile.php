                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="username" value="<?php echo htmlspecialchars($organizer['username']); ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="name" value="<?php echo htmlspecialchars($organizer['name']); ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="email" name="email" value="<?php echo htmlspecialchars($organizer['email']); ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="number" name="phone" value="<?php echo htmlspecialchars($organizer['phone']); ?>" required>
                                </div>
                            </div>
                        </div>
